...
\noindent This book is part of an evolving project. To keep up to date and see future recipes and hollering, visit \mbox{\urlfont http://mealtime.with.maddypa.ws}
...
\include{ghee/content}

\include{dal/content}

\include{preserved-lemons-1/content}

\include{summer-salad/content}

\include{tabbouleh/content}

\include{preserved-lemons-2/content}

\include{shakshouka/content}

\include{tamago-kake-gohan/content}

\include{kimchi-1/content}

\include{juk/content}

\include{kimchi-2/content}

\include{sichuan-beans/content}

\include{kimchi-3/content}

\include{mul-naengmyeon/content}

\include{okonomiyaki/content}

\include{orange-sauce/content}

\include{green-chili/content}

\include{preserved-lemons-3/content}

\include{baba-ganoush/content}

\include{mac-n-cheese/content}

\include{bananas-foster/content}
...
\include{preserved-lemons-1/recipe}

\include{summer-salad/recipe}

\include{tabbouleh/recipe}

\include{shakshouka/recipe}

\include{tamago-kake-gohan/recipe}

\include{kimchi-1/recipe}

\include{juk/recipe}

\include{sichuan-beans/recipe}

\include{mul-naengmyeon/recipe}

\include{okonomiyaki/recipe}

\include{orange-sauce/recipe}

\include{green-chili/recipe}

\include{baba-ganoush/recipe}

\include{mac-n-cheese/recipe}

\include{bananas-foster/recipe}
