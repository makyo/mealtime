...
\include{food/ghee/content}

\include{food/dal/content}

\include{food/preserved-lemons/content-1}

\include{food/summer-salad/content}

\include{food/tabbouleh/content}

\include{food/preserved-lemons/content-2}

\include{food/shakshouka/content}

\include{food/tamago-kake-gohan/content}

\include{food/kimchi/content-1}

\include{food/juk/content}

\include{food/kimchi/content-2}

\include{food/sichuan-beans/content}

\include{food/kimchi/content-3}

\include{food/mul-naengmyeon/content}

\include{food/okonomiyaki/content}

\include{food/orange-sauce/content}

\include{food/green-chili/content}

\include{food/preserved-lemons/content-3}

\include{food/baba-ganoush/content}

\include{food/mac-n-cheese/content}

\include{food/champurrado/content}

\include{food/bananas-foster/content}
...
\include{food/ghee/recipe}

\include{food/dal/recipe}

\include{food/preserved-lemons/recipe}

\include{food/summer-salad/recipe}

\include{food/tabbouleh/recipe}

\include{food/shakshouka/recipe}

\include{food/tamago-kake-gohan/recipe}

\include{food/kimchi/recipe}

\include{food/juk/recipe}

\include{food/sichuan-beans/recipe}

\include{food/mul-naengmyeon/recipe}

\include{food/okonomiyaki/recipe}

\include{food/orange-sauce/recipe}

\include{food/green-chili/recipe}

\include{food/baba-ganoush/recipe}

\include{food/mac-n-cheese/recipe}

\include{food/champurrado/recipe}

\include{food/bananas-foster/recipe}
